...
void Core::run_simplesim(){
	...
	pprint(1)<<"+--------+--------+--------+--------+--------+--------+"<<endl;
	pprint(1)<<"|           Register Values at Termination            |"<<endl;
	pprint(1)<<"+--------+--------+--------+--------+--------+--------+"<<endl;
	...
	pprint(1)<<"+--------+--------+--------+--------+--------+--------+"<<endl;
	pprint(1)<<"|           Vector Values at Termination            |"<<endl;
	pprint(1)<<"+--------+--------+--------+--------+--------+--------+"<<endl;

	for (int k = 0; k< 16 ; k++){
		pprint(1)<<right<<hex<<setw(8)<<V[k]<<"|";
	}
	pprint(1)<<endl;
