...
void Core::decode() {
	...
	bool rdcheck = temp_isVMov1 ||temp_IsVAdd || temp_isVSub || temp_isVMul || temp_isVDiv || temp_isVAnd || temp_isVOr || temp_isVLd || temp_isVMod;
	if (temp_isRet){
		temp_operand1 = R[15];
...
void Core::write_back() {
	...
	bool temp_isVOr = ma_rw.isVOr.Read();
